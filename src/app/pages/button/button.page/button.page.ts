...
import { WuiButton, WuiIcon, WuiPage, WuiPageService, WuiScrollbar } from '@wajek/wui';
...
@Component({
  ...
  imports: [RouterLink, WuiButton, WuiIcon, WuiPage, ShowcaseComponent, WuiScrollbar],
